...
class UpdateDsn extends StatefulWidget{
  ...
  UpdateDsn({ required this.title,required this.dsn, required this.nimcari});

  @override
  _UpdateDsnState createState() => new _UpdateDsnState(title,nimcari,dsn);
}
...
class _UpdateDsnState extends State<UpdateDsn>{
  ...
  _UpdateDsnState(this.title, this.nimcari, this.dsn);
                                ...
                                actions: <Widget>[
                                  TextButton(
                                    onPressed: () async{
                                      ...
                                      ApiService().updateDsnwithFoto(this.dsn, _imageFile, title, nimcari).then((isSuccess) {
